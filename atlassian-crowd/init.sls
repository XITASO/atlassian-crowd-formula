...
crowd-server-xsl:
  ...
  cmd.run:
    - name: |
        xsltproc \
          --stringparam pHttpPort "{{ crowd.get('http_port', '') }}" \
          --stringparam pHttpScheme "{{ crowd.get('http_scheme', '') }}" \
          --stringparam pHttpProxyName "{{ crowd.get('http_proxyName', '') }}" \
          --stringparam pHttpProxyPort "{{ crowd.get('http_proxyPort', '') }}" \
          --stringparam pAjpPort "{{ crowd.get('ajp_port', '') }}" \
          -o "{{ crowd.dirs.temp }}/server.xml" "{{ crowd.dirs.temp }}/server.xsl" server.xml
